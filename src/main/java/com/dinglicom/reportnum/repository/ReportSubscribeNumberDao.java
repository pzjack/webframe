...
public interface ReportSubscribeNumberDao extends PagingAndSortingRepository<ReportSubscribeNumber, Long> {
    ...
    @Query("select new com.dinglicom.reportnum.demain.LineDataTmp(a.org.id, a.org.name, a.org.dealer_name, a.product.id, a.product.shortname, a.product.producttype, sum(a.reportnum)) from ReportSubscribeNumber a where a.year=:year and a.month=:month and a.day=:day and a.org.id=:depid group by a.org.id, a.org.name, a.org.dealer_name, a.product.id, a.product.shortname, a.product.producttype")
    ...
    @Query("select new com.dinglicom.reportform.domain.SalemanTmp(a.org.id, a.org.name, a.org.userinfo.id, a.org.userinfo.realname, a.product.id, a.product.shortname, sum(a.reportnum)) from ReportSubscribeNumber a where a.year=:year and a.month=:month and a.day=:day  group by a.org.id, a.org.name, a.org.userinfo.id, a.org.userinfo.realname, a.product.id, a.product.shortname")
